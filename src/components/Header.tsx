...
const Header = () => {
  ...
  return (
    <header className="fixed top-10 left-0 right-0 z-40 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
